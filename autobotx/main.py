...
def main():
    ...
    def gesture_mode_action_for_detection(detected_count_value, is_pinch):
        ...
        jarvis = bool(action.get("autobotx", False))
    ...
    def chat_reply(user_text):
        ...
        def local_fallback_reply(raw_text, lowered_text, weather_text):
            ...
            if any(phrase in lowered_text for phrase in ["who are you", "what are you", "your name", "who is this"]):
                return "I am autobotx, your voice assistant."
        ...
        system_prompt = (
            "You are autobotx, warm, natural, and concise. "
    ...
    def handle_voice_command(text):
        ...
        if "jarvis on" in command or "activate jarvis" in command or command == "autobotx":
            reply("autobotx on")
            return
    ...
    while True:
                ...
                if current_mode == "GESTURE":
                    if detected_count == 0:
                        ...
                        if gesture_action:
                            ...
                            jarvis_active = bool(gesture_action["autobotx"])
                        else:
        ...
        cv2.putText(frame, "autobotx CONTROL HUD", (18, 30), 1, 1.0, (240, 240, 255), 2)
        ...
        cv2.imshow("autobotx Interface", frame)
